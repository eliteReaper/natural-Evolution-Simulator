...
''' 
    Red Color Units are faster than base units
    Green Color Units are base units
    Blue Color Units are slower than base Units

    The Size of Unit determines the radius of the inner circle
    The Size of the Outer Circle determines the range in which if a Unit comes then it will be eaten
        by another sufficiently larger unit.
'''
counter = 1
